...
export default function Home() {
  ...
  <div className="max-w-5xl mx-auto px-4 sm:px-6">
    ...
    <h2 className="text-4xl font-bold text-center mb-8 text-[#5C3A21]">
      🫏 Cos'è FantaMiccio?
    </h2>

    <p className="text-lg text-[#5C3A21] leading-8">
      <strong>
        FantaMiccio è il fantasy game dedicato al Palio dei Micci di Querceta.
      </strong>
    ...
    <div className="mt-10 space-y-4 text-[#5C3A21]">
      ...
      <div className="pt-5">
        ⭐ <strong>Fai crescere la popolarità della tua Contrada</strong>
      </div>
