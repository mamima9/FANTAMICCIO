          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-1 transition">
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-500">Badge ottenuti</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10 bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-amber-50 rounded-2xl p-6 text-center">
                <p className="text-gray-500">⭐ Punti</p>
            ...
            <div className="md:flex justify-between items-center">
              <div>
                ...
                <p className="mt-4 text-white/90 max-w-xl text-lg">
                  ...
                  Scopri tutte le competizioni dedicate alla tua
                  Contrada, affronta le altre e conquista nuovi
                  badge.
                </p>
              </div>
